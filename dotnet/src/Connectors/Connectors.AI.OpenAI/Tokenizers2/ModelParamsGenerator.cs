...
using Microsoft.SemanticKernel.Connectors.AI.OpenAI.Tokenizers2.Settings;
...
public readonly struct ModelParams
{
    ...
    {
        this.ExplicitNVocab = explicitNVocab;
        this.PatStr = patStr;
        this.MergeableRanks = mergeableRanks;
        this.SpecialTokens = specialTokens ?? new Dictionary<string, int>();
    }
}
...
public static class ModelParamsGenerator
{
    ...
    {
        var mergeableRanks = EmbeddedResource.LoadTokenBytePairEncoding("SharpToken.data.r50k_base.tiktoken");
    ...
    {
        var mergeableRanks = EmbeddedResource.LoadTokenBytePairEncoding("SharpToken.data.p50k_base.tiktoken");
    ...
    {
        var mergeableRanks =
            EmbeddedResource.LoadTokenBytePairEncoding("SharpToken.data.cl100k_base.tiktoken");
